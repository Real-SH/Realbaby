...
export const metadata: Metadata = { title: "About Realbaby", description: "Meet Realbaby, an OEM/ODM partner focused on baby soft play, comfort, and early-learning products." };
