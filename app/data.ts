...
export const companyProfile = {
  brandName: "RealBaby",
  foundedYear: "2021",
  positioning: "Baby Soft Play & Developmental Products OEM/ODM Partner",
  marketFocus: ["United States", "Canada", "Australia", "United Kingdom", "Europe"],
  founder: "Karen",
  founderExperience: "15+ years in baby toys and related products"
};
...
const commonSpecs = [
  ...
  { key: "Testing Support", value: "EN71, ASTM F963, CPSIA-related requirements, and product-specific CPC preparation according to market and project scope" }
];
